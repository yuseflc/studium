    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            {hasAnyTasks ? (
                ...
                <div className="card bg-base-100 border border-base-300 shadow-sm p-12 flex flex-col items-center justify-center text-center">
                    <p className="text-xl font-bold text-base-content/60">No hay registros</p>
                    <p className="text-sm text-base-content/40 mt-2">El alumno no tiene tareas asignadas o entregadas.</p>
                </div>
            )}
        </div>
    );
