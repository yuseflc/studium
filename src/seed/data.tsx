/* Archivo: src\seed\data.tsx
  Descripción: Datos de ejemplo (mocks) usados por el seeder y componentes en desarrollo. */

// Datos de ejemplo para poblar el seed y facilitar pruebas en desarrollo
// Contiene estructuras de cursos, unidades y recursos de muestra
